-- Cup of Joy Fresh Supabase Setup
-- Run this in a brand-new Supabase project's SQL Editor.
--
-- This is the SQL-only setup. No Supabase CLI and no Edge Function deploy required.
--
-- Recommended order:
-- 1. Create your new Supabase project.
-- 2. Create the owner Auth user for benedick.tiaga04@gmail.com.
-- 3. Run this whole SQL file.
-- 4. Add frontend env vars to local .env and Netlify.
--
-- If you run this before creating the owner Auth user, create the user,
-- then run this SQL file again so the owner profile is inserted.
